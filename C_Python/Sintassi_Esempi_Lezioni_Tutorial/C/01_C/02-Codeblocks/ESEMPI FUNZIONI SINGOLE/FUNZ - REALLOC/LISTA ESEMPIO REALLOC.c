...
if(j == 5)
    ...
    printf("%s = %d   ", testaB -> chiave, testaB -> data);}
     ...
     printf("\n\n%s = %d", testaA -> chiave, testaA -> data);  //Output : - Segmentation Fault -
     printf("\n\n%s = %d", testaB -> chiave, testaB -> data);} //(Le Liste Sono State Distrutte Con Successo)
